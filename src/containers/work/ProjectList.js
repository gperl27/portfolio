...
const ProjectList = ({ classes }) =>
    ...
    >
        <Project
            ...
            summary='Symphonics translates any amount of arbitrary text into a musical composition on the fly.'
            technologies={['React', 'Webpack', 'JavaScript']}
            link={'https://chrome.google.com/webstore/detail/symphonics/igehhhilgkafagloijklhimkkojkkdmi'}
            media={'/images/symphonics.png'}
        />
        <Project
            title='Wallkeepers'
